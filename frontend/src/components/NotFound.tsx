    ...
    <StyledWrapper>
      <div className="main_wrapper">
        <div className="main">
          ...
          <div className="tv">
            <div className="cruve">
              <svg className="curve_svg" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 189.929 189.929" xmlSpace="preserve">
            ...
            <div className="display_div">
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen" onClick={() => navigate('/')}>
                    <span className="notfound_text">NOT FOUND</span>
                    <span className="home_text">Go Home</span>
                  </div>
                  <div className="screenM" onClick={() => navigate('/')}>
                    <span className="notfound_text">NOT FOUND</span>
                    <span className="home_text">Go Home</span>
                  </div>
                </div>
...
const StyledWrapper = styled.div`
  ...
  .screen:hover .home_text,
  .screenM:hover .home_text {
    opacity: 1;
  }
